...
[Robin Lovelace](https://www.robinlovelace.net/) is Professor of Transport Data Science at the Leeds Institute
...
modelling scenarios of change. Robin is Lead Developer of the Propensity to Cycle Tool (see [www.pct.bike](https://www.pct.bike/)) and follow-on projects such as the Network Planning Tool for Scotland ([NPT](https://npt.scot/)), Principal Investigator of the Department for Transport funded SaferActive project and author of popular open source software packages (such as stplanr) and books
