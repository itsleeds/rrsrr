...
It is meant to be a handbook, taken out into the field of applied research and referred to frequently in the course of an analysis project.
...
R allows you to code analysis for reproducible research; reproducible in the sense that others can check and verify it as well as borrow, share and adapt it to their own work. Analysts can also repeat their own work as fresh data becomes available – there's no need to reinvent the wheel. The openness, efficiency and power of working in R offers the opportunity, if taken, to improve how road safety analysis gets done.
Let's be honest: like learning any new skill, effort is needed upfront to reap the benefits of this new way of working. But we firmly believe the effort is worth it, and we think this manual is a great way to get you started.
...
[Robin Lovelace](https://www.robinlovelace.net/) is a Professor of Transport Data Science at the Leeds Institute
...
modelling scenarios of change.

Robin is the lead developer of the [{stats19}](https://docs.ropensci.org/stats19/) R package and author of several papers on road safety that use some of the data science techniques presented in this book. He is also the Lead Developer of the Propensity to Cycle Tool (see [www.pct.bike](https://www.pct.bike/)) and follow-on projects such as the Network Planning Tool for Scotland ([NPT](https://npt.scot/)), Principal Investigator of the Department for Transport funded SaferActive project and author of popular open-source software packages (such as stplanr) and books
